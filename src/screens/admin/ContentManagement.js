...
const listings = [
    ...
    {
        id: 3,
        name: 'Scholarship Scams to avoid',
    ...
    {
        id: 4,
        name: 'FAFSA Explained',
        subtitle: '5m 15s. Educational video',
        icon: 'graduation-cap', // FontAwesome5
        bgColor: '#5BA4DE', // Blue
        logos: [VendorLogoK],
    },
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.mainTitle}>Content Management</Text>
                <Text style={styles.subtitle}>
                    Review, approve, and monitor educational videos and learning content across Cash 4 Edu
                </Text>
                ...
                <View style={styles.actionButtonsRow}>
                    ...
                    <TouchableOpacity style={styles.createButton}>
                        ...
                        <Text style={styles.createText}>Upload New Content</Text>
                    </TouchableOpacity>
                </View>
            </View>
            <ScrollView>
                ...
                <View >
                    ...
                    <View style={styles.dropdownsRow}>
                        {['All Status', 'All Content Type', 'All Categories'].map((label, index) => (
                ...
                <View style={styles.lastcard}>
                    <Text style={styles.listTitle}>Content Moderation</Text>
                    <View style={{padding:10}}>
                        <Text style={styles.qtyTitle}>Quality Review</Text>
                        <Text style={styles.qtySubTitle}>AI-assisted content analysis</Text>
                        <TouchableOpacity style={[styles.btn1,{backgroundColor:'#A855F7'}]}>
                            <FontAwesome5 name='robot' size={16} color="white"/>
                            <Text style={styles.btntxt}>Run Quality Scan</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={{padding:10}}>
                        <Text style={styles.qtyTitle}>Policy Check</Text>
                        <Text style={styles.qtySubTitle}>Compliance & copyright scanner</Text>
                        <TouchableOpacity style={[styles.btn1,{backgroundColor:'#FFB636'}]}>
                            <FontAwesome5 name='check-circle' size={16} color="white"/>
                            <Text style={styles.btntxt}>Check Compliance</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={{padding:10}}>
                        <Text style={styles.qtyTitle}>Token Audit</Text>
                        <Text style={styles.qtySubTitle}>Review reward allocations</Text>
...
const styles = StyleSheet.create({
    ...
    lastcard: {
        ...
        borderRadius: 12,
        padding: 16,
        marginBottom: 10, // Final margin for scroll clearance
    },
    listTitle: {
        color: '#FFFFFF',
        fontSize: 20,
